...
%   BoldFont = *-Semibold,
%   ItalicFont = *-Italic,
%   BoldItalicFont = *-SemiboldItalic]{AGaramondPro}
%\setmainfont{CMU Serif Roman}
%%%%%%%%%seem to be a problem only for TexLive
%\font\nullfont=cmr10
...
\makeglossaries
\newacronym{PMC}{PMC}{Principle of Minimal Compliance}
...
\include{mainmatter/chap6}
%%%%%%!!!!!!!!!Remember to delete!!!!!!!!!!!!
%\include{mainmatter/resources}


%\begin{appendices}
%  \include{mainmatter/simple-2}
%\end{appendices}
