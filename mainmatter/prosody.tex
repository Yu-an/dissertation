...
\chapter{\revise{Prosody, clause types, and speech acts in English}}
\label{chap:prosody}
...
When interrogatives are used to perform requests like \tit{Can you pass the salt?} the most natural prosodic contour seems to be regular polar interrogative contour. 
