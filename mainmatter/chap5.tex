...
%In particular,  you need to say that the child has a prior theory of what questions do (seek information/responses) and some assumptions about human nature that would lead them to expect that people would pause more after a question (because the questioner was expecting a response) or that speakers would look more at their interlocutor after a questions (because the questioner was expecting a response). The point of this chapter can’t be “we looked at some stuff that might be relevant and its potentially reliable”. Instead, the point has to be that *if* children had a theory of language use and specifically a theory of what questions are for, then that would lead them to expect differences in pauses and follow-in looking after questions as compared to the other speech acts. And a child with those expectations might find just enough information in their parents’ behavior that it would help them solve the clustering problems we discussed in chapter 3
